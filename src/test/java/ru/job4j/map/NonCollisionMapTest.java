...
class NonCollisionMapTest {
    ...
    @Test
    void whenCheckPutGetRemove() {
        SimpleMap<String, String> map = new NonCollisionMap<>();
        assertThat(map.put("key1", "val1")).isTrue();
        assertThat(map.put("key1", "val2")).isFalse();
        assertThat(map.get("key1")).isEqualTo("val1");
        assertThat(map.remove("key1")).isTrue();
        assertThat(map.get("key1")).isEqualTo(null);
    }

    @Test
    void whenCheckPutGetRemoveNullKey() {
        SimpleMap<String, String> map = new NonCollisionMap<>();
        assertThat(map.put(null, "val1")).isTrue();
        assertThat(map.put(null, "val2")).isFalse();
        assertThat(map.get(null)).isEqualTo("val1");
        assertThat(map.remove(null)).isTrue();
        assertThat(map.get(null)).isNull();
    }
}